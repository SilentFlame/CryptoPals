...
#Taking the top 100 most commonly used English word. 
...
#taking "encoded.txt" contains all the hex encoded strings from which we have to detect.
for line in open('encoded.txt','r').readlines():
    body(line)
